...
Sub lee_polygono(aa As String, mm() As gpc_vertex)
	...
	'calculo factor de escala y limites (solo para el poligono primero, el principal)
...
End Sub
	...
	Dim As String poligonos_a="britain.txt"
	Dim As String poligonos_b="arrows.txt"
